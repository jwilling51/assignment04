...
General questions for office hours: 
Should we be doing all of our coding in the index.qmd file, or in a separate file?
...
Questions about this graph for office hours:
Adding number labels on each bubble?
...
Questions about this graph for office hours:
Should we get rid of the rows that are causing the warning? Or just suppress the warning?
...
Can I make these a bit wider? It's very condensed right now
