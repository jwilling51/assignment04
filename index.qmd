...
inadmissibles_2014 |>
  ...
  labs(x = "Country of origin", y = "Age", title = "Age Distributions by Country of Origin for Top 10 Countries (2014)") +
  theme(axis.text.x = element_text(angle = 45, vjust = .85))
...
inadmissibles_2014 |>
  ...
  labs(x = "Month", y = "Number of Crossings", title = "Inadmissibles by Month, Country, and Mode of Transport for\nTop 10 Countires of Origin (2014)", color = "Country of Origin", shape = "Country of Origin")
